...
import Img from '../../assets/Proabout.webp';
import HighSmall from '../../assets/Propanda.webp';
import BugImg from '../../assets/canvalogo.webp'
import height from '../../assets/Protab1a.webp'
import hegihttab2 from '../../assets/Protab2.jpg'
import hegihttab3 from '../../assets/Protab3a.webp'
        ...
        <div>
           <Header />
            ...
            <div className="max-w-7xl mx-auto text-center mt-[80px]">
                <h3 className="text-4xl font-extrabold text-[#091d4f] mt-2">Select Your Industry</h3>
            ...
            <div className="max-w-7xl mx-auto mt-8">
                ...
                <div className="tab-content mt-8">
                    {activeTab === 1 && (
                        <div className="flex flex-col md:flex-row items-center  p-8 rounded-lg">
                            ...
                            <div className="md:w-1/2 ml-[85px]">
                                <p className="mt-4 text-lg text-gray-700 leading-relaxed">
                                    The Instructure Learning Platform is the open, reliable, extensible learning ecosystem enabling the just-right digital learning environment for educators, students, and institutions.
                                </p>
                                <Link to={'/about'}>
                ...
                <div className='lg:mt-35 mt-52 relative'>
